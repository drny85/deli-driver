          ...
          <Animatble.View
              ...
              {otp.map((digit, index) =>
                showNumber ? (
                  <MotiView
                    ...
                    <Text
                      style={{ fontFamily: 'Genos-Bold', fontSize: 26, color: Colors.main }}
                      key={index}>
                      {digit}
                    </Text>
                  </MotiView>
            ...
            <View style={styles.digitsRow}>
              <DIGIT
                lenght={lenght}
                value={
                  <Feather name={showNumber ? 'eye' : 'eye-off'} size={24} color={Colors.main} />
                }
  ...
  return (
    <TouchableOpacity disabled={otp?.length === lenght} onPress={onPress} activeOpacity={0.7}>
      <NeoView rounded size={80}>
        <Text style={{ fontFamily: 'Genos-Bold', fontSize: 26, color: Colors.main }}>{value}</Text>
      </NeoView>
    </TouchableOpacity>
  );
};
